...
describe("BigIntAsDecimal.ROUND_*", () => {
  ...
  for (const mode of Object.keys(manualCases)) {
    ...
    describe(mode, () => {
      ...
      it("should produce the same results as does Math-based implementation #1 sequence", () => {
      ...
      it("should produce the same results as does Math-based implementation #2 random", () => {
        for (let i = 0; i < 1000; i++) {
